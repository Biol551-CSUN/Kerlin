...
```{r 2021_03_24_lab_assignment_1, fig.width = 8, fig.height = 5, fig.cap = "Figure 1. Penguin body mass (g) by sex and species", fig.align= "center"}
#### Create boxplot ##################################################
...
```{r 2021_03_24_lab_assignment_2, fig.width = 8, fig.height = 5, fig.cap = "Figure 2. Penguin bill length (mm) by sex and species", fig.align= "center"}
...
```
<center>
![](https://lh3.googleusercontent.com/proxy/Y_AKdcIue4p372wTA23WPPe4uawyttZzm6DNvjFTy-miTFEovJRSYJ-SJ5JZxv31nZHkhNBF0DRBIfKbQWMKS5rNLbO0U3CHMfH2Sa1ejN7Mhk1eWzEKwAM9Ti3x7L2lavqygOaGk59RQA)
</center>
